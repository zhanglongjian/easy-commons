 ...
 * 检查文本中是否有中文的工具类
 * 
 * @author zhanglj 2016年9月28日
 * 
 */
public class ChineseWordsCheckUtils {

	public static void main(String[] args) {
		String[] strArr = new String[] { "www.micmiu.com", "!@#$%^&*()_+{}[]|\"'?/:;<>,.", "！￥……（）——：；“”‘’《》，。？、", "不要啊", "やめて", "韩佳人", "???" };
		for (String str : strArr) {
			System.out.println("===========> 测试字符串：" + str);
			System.out.println("正则判断结果：" + hasChineseByREG(str) + " -- " + hasChineseByName(str));
	...
	// 只能判断部分CJK字符（CJK统一汉字）
	public static boolean hasChineseByName(String str) {
		if (str == null) {
			return false;
		}
